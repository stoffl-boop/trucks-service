package com.taxi.taxicontent.configuration;

import com.taxi.taxicontent.service.TruckDriverDetailsService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                .antMatchers("/admin_truck_orders").hasAuthority("ADMIN")
