...
d[c]=e,"o"===b[1]&&H(a[e]))});a._hungarianMap=d}function L(a,b,c){a._hungarianMap||H(a);var d;f.each(b,function(e,h){d=a._hungarianMap[e];d===p||!c&&b[d]!==p||("o"===d.charAt(0)?(b[d]||(b[d]={}),f.extend(!0,b[d],b[e]),L(a[d],b[d],c)):b[d]=b[e])})}function Ga(a){var b=q.defaults.oLanguage,c=b.sDecimal;c&&Ha(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&d&&"Немає записів"===b.sEmptyTable&&M(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&d&&"Loading..."===b.sLoadingRecords&&M(a,a,
...
fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Перші",sLast:"Останні",
sNext:"Далі",sPrevious:"Назад"},sEmptyTable:"Немає записів",sInfo:"Відображено записи з _START_ до _END_ з _TOTAL_",sInfoEmpty:"Пошук не дав результатів",sInfoFiltered:"(пошук проведено серед _MAX_ записів)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Відобразити _MENU_ результатів",sLoadingRecords:"Завантаження...",sProcessing:"Обробка...",sSearch:"Пошук:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Нема результатів"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
